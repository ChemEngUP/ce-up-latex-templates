...
For chemical symbols, use the chemformula package to get nicely typeset chemical
names. You can use it in the text like \ch{H2O} or in equations like below:
\begin{align}
